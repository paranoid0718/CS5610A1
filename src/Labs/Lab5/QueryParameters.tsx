...
export default function QueryParameters(){
    ...
    return (
            ...
            <a id="wd-query-parameter-add" className="btn btn-primary me-2 mb-2"
                href={`${HTTP_SERVER}/lab5/calculator?operation=add&a=${a}&b=${b}`}>
                Add {a} + {b}
            </a>
            <a id="wd-query-parameter-subtract" className="btn btn-danger me-2 mb-2"
                href={`${HTTP_SERVER}/lab5/calculator?operation=subtract&a=${a}&b=${b}`}>
                Substract {a} - {b}
            </a>
            <br/>
            <a id="wd-query-parameter-multiply" className="btn btn-success me-2 mb-2"
                href={`${HTTP_SERVER}/lab5/calculator?operation=multiply&a=${a}&b=${b}`}>
                multiply {a} * {b}
            </a>
            <a id="wd-query-parameter-divide" className="btn btn-warning me-2 mb-2"
