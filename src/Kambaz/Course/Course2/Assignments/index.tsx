    ...
    <div id="wd-assignments">
      ...
      <ul id="wd-assignment-list">
        <li className="wd-assignment-list-item">
          <a href="#/Kambaz/Courses/4321/Assignments/123"
        ...
        <li className="wd-assignment-list-item">
          <a href="#/Kambaz/Courses/4321/Assignments/456"
             className="wd-assignment-link">
            A2 - Black Red Tree
          </a>
          <div>Multiple Modules | <strong>Not available until</strong> May 13 at 12:00am | <strong>Due</strong> May 20 at 11:59pm | 100 pts</div>
        ...
        <li className="wd-assignment-list-item">
          <a href="#/Kambaz/Courses/4321/Assignments/789"
             className="wd-assignment-link">
            A3 - Queue and Heap
          </a>
      ...
      <h3 id="wd-Quizzes-title">
        ...
        <li className="wd-quiz-list-item">
          <a href="#/Kambaz/Courses/4321/Assignments/q1"
        ...
        <li className="wd-quiz-list-item">
          <a href="#/Kambaz/Courses/4321/Assignments/q2"
             className="wd-quiz-link">
            Quiz2
          </a>
          <div>Multiple Modules | <strong>Not available until</strong> May 13 at 12:00am | <strong>Due</strong> May 20 at 11:59pm | 100 pts</div>
        ...
        <li className="wd-quiz-list-item">
          <a href="#/Kambaz/Courses/4321/Assignments/q3"
             className="wd-quiz-link">
            Quiz3
          </a>
          <div>Multiple Modules | <strong>Not available until</strong> May 20 at 12:00am | <strong>Due</strong> May 27 at 11:59pm | 100 pts</div>
        ...
        <li className="wd-exam-list-item">
          <a href="#/Kambaz/Courses/4321/Assignments/midterm"
        ...
        <li className="wd-exam-list-item">
          <a href="#/Kambaz/Courses/4321/Assignments/final"
             className="wd-exam-link">
            Final
          </a>
          <div>Multiple Modules | <strong>Not available until</strong> May 13 at 12:00am | <strong>Due</strong> May 20 at 11:59pm | 100 pts</div>
        ...
        <li className="wd-project-list-item">
          <a href="#/Kambaz/Courses/4321/Assignments/project"
